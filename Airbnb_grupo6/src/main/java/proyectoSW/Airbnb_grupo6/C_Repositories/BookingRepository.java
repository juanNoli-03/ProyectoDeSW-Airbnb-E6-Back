...
public interface BookingRepository extends JpaRepository<Booking, Long>{
    ...
    @Query("SELECT b FROM Booking b  JOIN FETCH b.user JOIN FETCH b.accommodation WHERE b.user.idUser = :idUser AND b.endDate < :endDate")
    ...
    @Query("SELECT b FROM Booking b JOIN FETCH b.user JOIN FETCH b.accommodation WHERE b.user.idUser = :idUser AND b.startDate > :startDate")
    ...
    @Query("SELECT b FROM Booking b JOIN FETCH b.user JOIN FETCH b.accommodation WHERE b.user.idUser = :idUser AND b.startDate < :nowDate AND b.endDate > :nowDate")
